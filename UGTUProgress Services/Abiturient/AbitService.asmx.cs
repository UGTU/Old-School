...
namespace Abiturient
{
    ...
    {
        private string conn = "Data Source=ugtudb.ugtu.net;Initial Catalog=UGTUTEST;Integrated Security=True";
        ...
        [WebMethod(Description = "Получает коллекцию наборов факультета для текущего года")]
        ...
        [WebMethod(Description = "Получает коллекцию гражданств")]
        ...
        [WebMethod(Description = "Получает коллекцию стран")]
        ...
        [WebMethod(Description = "Получает коллекцию регионов страны")]
        ...
        [WebMethod(Description = "Получает коллекцию районов региона")]
        ...
        [WebMethod(Description = "Получает коллекцию городов района")]
        ...
        [WebMethod(Description = "Получает коллекцию улиц города")]
        ...
        [WebMethod(Description = "Получает коллекцию учебных заведений города")]
            ...
            int? CommunityJobKey, int? FamStateKey, int? SpecCountKey, int? SchoolKey, int? GraduateYear,  string AdditionalInfo, int? ServiceRecYears, int? ServiceRecMonths, string Duty, int? OrganizationKey, string Benefits)
        {
            ...
            using (DataLayer.AbitDataContext ctx = new DataLayer.AbitDataContext(conn))
            {
            int? code = Convert.ToInt16(ctx.AppendAbit(1, LastName, FirstName, MiddleName, Birth, BirthPlace, IsPhysChallenged, HasKids,
        ...
        public void EditAbitDoc(int ncode, int DocTypeID, string Serie, string Number, string GivenBy, DateTime Given)
        {
            using (DataLayer.AbitDataContext ctx = new DataLayer.AbitDataContext(conn))
            {
                ctx.AppendDocs(0, DocTypeID, ncode, Given, GivenBy, Number, Serie, DocTypeID);
                return;
            }
        }
        ...
        public int AddAbitAppl(int ncode, int RecruitID, int CatID, bool isMain)
        {
            ...
            using (DataLayer.AbitDataContext ctx = new DataLayer.AbitDataContext())
            {
