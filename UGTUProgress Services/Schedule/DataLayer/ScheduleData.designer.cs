...
namespace Schedule.DataLayer
{
    ...
    partial void InsertCalc_unit(Calc_unit instance);
    partial void UpdateCalc_unit(Calc_unit instance);
    partial void DeleteCalc_unit(Calc_unit instance);
    ...
    partial void InsertPotok_shema(Potok_shema instance);
    partial void UpdatePotok_shema(Potok_shema instance);
    partial void DeletePotok_shema(Potok_shema instance);
    ...
    partial void DeleteYear_uch_pl(Year_uch_pl instance);
		...
		public ScheduleDataDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["UGTUConnectionString1"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<Calc_unit> Calc_units
		{
			get
			{
				return this.GetTable<Calc_unit>();
			}
		}
		...
		public System.Data.Linq.Table<Potok_shema> Potok_shemas
		{
			get
			{
				return this.GetTable<Potok_shema>();
			}
		}
	...
	public partial class Relation_calc_unit_grup : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<Calc_unit> _Calc_unit;
    ...
    partial void Onik_calc_unitChanged();
		...
		{
			this._Calc_unit = default(EntityRef<Calc_unit>);
		...
		public int ik_calc_unit
		{
			...
			set
			{
				...
				{
					if (this._Calc_unit.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Calc_unit_Relation_calc_unit_grup", Storage="_Calc_unit", ThisKey="ik_calc_unit", OtherKey="ik_calc_unit", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public Calc_unit Calc_unit
		{
			get
			{
				return this._Calc_unit.Entity;
			}
			set
			{
				Calc_unit previousValue = this._Calc_unit.Entity;
				if (((previousValue != value) 
							|| (this._Calc_unit.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._Calc_unit.Entity = null;
						previousValue.Relation_calc_unit_grup = null;
					}
					this._Calc_unit.Entity = value;
					if ((value != null))
					{
						value.Relation_calc_unit_grup = this;
					...
					this.SendPropertyChanged("Calc_unit");
				}
			}
		}
    ...
    partial void Oncommission_memberChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Calc_unit_Prepod_plan_nagr", Storage="_Calc_unit", ThisKey="ik_calc_unit", OtherKey="ik_calc_unit", IsForeignKey=true)]
		public Calc_unit Calc_unit
		{
			get
			{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.Calc_unit")]
	public partial class Calc_unit : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<Relation_calc_unit_grup> _Relation_calc_unit_grup;
		
		private EntitySet<Prepod_plan_nagr> _Prepod_plan_nagrs;
		
		private EntityRef<Potok_shema> _Potok_shema;
    ...
    partial void Onik_uch_planChanged();
		...
		public Calc_unit()
		{
			this._Relation_calc_unit_grup = default(EntityRef<Relation_calc_unit_grup>);
			...
			this._Potok_shema = default(EntityRef<Potok_shema>);
			OnCreated();
		}
		...
		public System.Nullable<int> ik_shema_of_potok
		{
			...
			set
			{
				...
				{
					if (this._Potok_shema.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Calc_unit_Relation_calc_unit_grup", Storage="_Relation_calc_unit_grup", ThisKey="ik_calc_unit", OtherKey="ik_calc_unit", IsUnique=true, IsForeignKey=false)]
		public Relation_calc_unit_grup Relation_calc_unit_grup
		{
			get
			{
				return this._Relation_calc_unit_grup.Entity;
			}
			set
			{
				Relation_calc_unit_grup previousValue = this._Relation_calc_unit_grup.Entity;
				if (((previousValue != value) 
							|| (this._Relation_calc_unit_grup.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._Relation_calc_unit_grup.Entity = null;
						previousValue.Calc_unit = null;
					}
					this._Relation_calc_unit_grup.Entity = value;
					if ((value != null))
					{
						value.Calc_unit = this;
					}
					this.SendPropertyChanged("Relation_calc_unit_grup");
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Calc_unit_Prepod_plan_nagr", Storage="_Prepod_plan_nagrs", ThisKey="ik_calc_unit", OtherKey="ik_calc_unit")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Potok_shema_Calc_unit", Storage="_Potok_shema", ThisKey="ik_shema_of_potok", OtherKey="ik_shema_of_potok", IsForeignKey=true, DeleteRule="CASCADE")]
		public Potok_shema Potok_shema
		{
			get
			{
				return this._Potok_shema.Entity;
			}
			set
			{
				Potok_shema previousValue = this._Potok_shema.Entity;
				if (((previousValue != value) 
							|| (this._Potok_shema.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._Potok_shema.Entity = null;
						previousValue.Calc_units.Remove(this);
					}
					this._Potok_shema.Entity = value;
					if ((value != null))
					{
						value.Calc_units.Add(this);
						this._ik_shema_of_potok = value.ik_shema_of_potok;
					}
					else
					{
						this._ik_shema_of_potok = default(Nullable<int>);
					}
					this.SendPropertyChanged("Potok_shema");
				}
			}
		}
    ...
    partial void Oni_commission_countChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Potok_shema_Content_plan_nagr", Storage="_Potok_shema", ThisKey="ik_shema_of_potok", OtherKey="ik_shema_of_potok", IsForeignKey=true)]
		public Potok_shema Potok_shema
		{
			get
			{
			...
			set
			{
							...
							|| (this._Potok_shema.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Potok_shema.Entity = null;
						previousValue.Content_plan_nagrs.Remove(this);
					}
					this._Potok_shema.Entity = value;
					if ((value != null))
					{
						value.Content_plan_nagrs.Add(this);
						this._ik_shema_of_potok = value.ik_shema_of_potok;
					}
					else
					{
						this._ik_shema_of_potok = default(int);
					}
					this.SendPropertyChanged("Potok_shema");
				}
			}
	...
	public partial class Potok : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<Potok_shema> _Potok_shemas;
    ...
    partial void Onik_year_enterChanged();
		...
		public Potok()
		{
			this._Potok_shemas = new EntitySet<Potok_shema>(new Action<Potok_shema>(this.attach_Potok_shemas), new Action<Potok_shema>(this.detach_Potok_shemas));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Potok_Potok_shema", Storage="_Potok_shemas", ThisKey="ik_potok", OtherKey="ik_potok")]
		public EntitySet<Potok_shema> Potok_shemas
		{
			get
			{
				return this._Potok_shemas;
			}
			set
			{
				this._Potok_shemas.Assign(value);
			}
		}
		...
		private void attach_Potok_shemas(Potok_shema entity)
		{
			this.SendPropertyChanging();
			entity.Potok = this;
		}
		
		private void detach_Potok_shemas(Potok_shema entity)
		{
			this.SendPropertyChanging();
			entity.Potok = null;
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.Potok_shema")]
	public partial class Potok_shema : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private string _cName_shema;
		
		private EntitySet<Calc_unit> _Calc_units;
		
		private EntitySet<Content_plan_nagr> _Content_plan_nagrs;
    ...
    partial void Onik_shema_of_potokChanging(int value);
    partial void Onik_shema_of_potokChanged();
    partial void Onik_potokChanging(System.Nullable<int> value);
    partial void Onik_potokChanged();
    partial void Onik_decompose_typeChanging(System.Nullable<byte> value);
    partial void Onik_decompose_typeChanged();
    partial void OncName_shemaChanging(string value);
    partial void OncName_shemaChanged();
    #endregion
		
		public Potok_shema()
		{
			this._Calc_units = new EntitySet<Calc_unit>(new Action<Calc_unit>(this.attach_Calc_units), new Action<Calc_unit>(this.detach_Calc_units));
			this._Content_plan_nagrs = new EntitySet<Content_plan_nagr>(new Action<Content_plan_nagr>(this.attach_Content_plan_nagrs), new Action<Content_plan_nagr>(this.detach_Content_plan_nagrs));
			this._Potok = default(EntityRef<Potok>);
			this._Shema_decompose = default(EntityRef<Shema_decompose>);
			OnCreated();
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ik_shema_of_potok", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int ik_shema_of_potok
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_cName_shema", DbType="VarChar(30)")]
		public string cName_shema
		{
			get
			{
				return this._cName_shema;
			}
			set
			{
				if ((this._cName_shema != value))
				{
					this.OncName_shemaChanging(value);
					this.SendPropertyChanging();
					this._cName_shema = value;
					this.SendPropertyChanged("cName_shema");
					this.OncName_shemaChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Potok_shema_Calc_unit", Storage="_Calc_units", ThisKey="ik_shema_of_potok", OtherKey="ik_shema_of_potok")]
		public EntitySet<Calc_unit> Calc_units
		{
			get
			{
				return this._Calc_units;
			}
			set
			{
				this._Calc_units.Assign(value);
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Potok_shema_Content_plan_nagr", Storage="_Content_plan_nagrs", ThisKey="ik_shema_of_potok", OtherKey="ik_shema_of_potok")]
		public EntitySet<Content_plan_nagr> Content_plan_nagrs
		{
			get
			{
				return this._Content_plan_nagrs;
			}
			set
			{
				this._Content_plan_nagrs.Assign(value);
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Potok_Potok_shema", Storage="_Potok", ThisKey="ik_potok", OtherKey="ik_potok", IsForeignKey=true, DeleteRule="CASCADE")]
		public Potok Potok
		{
			get
			{
			...
			set
			{
							...
							|| (this._Potok.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.Potok_shemas.Remove(this);
					}
					this._Potok.Entity = value;
					if ((value != null))
					{
						value.Potok_shemas.Add(this);
						this._ik_potok = value.ik_potok;
					}
					else
					{
						this._ik_potok = default(Nullable<int>);
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Shema_decompose_Potok_shema", Storage="_Shema_decompose", ThisKey="ik_decompose_type", OtherKey="ik_decompose_type", IsForeignKey=true)]
		public Shema_decompose Shema_decompose
		{
			...
			set
			{
							...
							|| (this._Shema_decompose.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._ik_decompose_type = default(Nullable<byte>);
					}
		...
		private void attach_Calc_units(Calc_unit entity)
		{
			this.SendPropertyChanging();
			entity.Potok_shema = this;
		}
		
		private void detach_Calc_units(Calc_unit entity)
		{
			this.SendPropertyChanging();
			entity.Potok_shema = null;
		}
		
		private void attach_Content_plan_nagrs(Content_plan_nagr entity)
		{
			this.SendPropertyChanging();
			entity.Potok_shema = this;
		}
		
		private void detach_Content_plan_nagrs(Content_plan_nagr entity)
		{
			this.SendPropertyChanging();
			entity.Potok_shema = null;
		}
    ...
    partial void OncName_decomposeChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Shema_decompose_Potok_shema", Storage="_Potok_shemas", ThisKey="ik_decompose_type", OtherKey="ik_decompose_type")]
		public EntitySet<Potok_shema> Potok_shemas
		{
			get
			{
