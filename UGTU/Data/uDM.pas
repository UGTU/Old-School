...
type
  ...
  Tdm = class(TDataModule, IDBActionPublisher)
    ...
    aspGetDiscModelik_uch_plan: TIntegerField;
    aspGetDiscModeliHour_gos: TIntegerField;
    aspGetDiscModelik_disc_uch_plan: TAutoIncField;
    aspGetDiscModelik_default_kaf: TIntegerField;
    aspGetDiscModelcName_disc: TStringField;
    aspGetDiscModeliIndivid: TIntegerField;
    ...
    aspGetDiscModellPract: TBooleanField;
    aspGetDiscModelik_type_disc: TWordField;
    ...
    aspGetDiscModelViborGroup: TIntegerField;
    ...
    aspGetDiscModeliK_pdgrp_disc: TIntegerField;
    ...
    aspGetDiscModeliK_spclz: TIntegerField;
    aspGetDiscModelcName_spclz_short: TStringField;
    adsProfile: TADODataSet;
    dsProfileForGroup: TDataSource;
    adsGroups: TADODataSet;
    aspGetDiscWork: TADOStoredProc;
    aspGetDiscWorkik_disc: TIntegerField;
    aspGetDiscWorkik_grp_disc: TIntegerField;
    aspGetDiscWorkik_ckl_disc: TIntegerField;
    aspGetDiscWorkik_pdgrp_disc: TIntegerField;
    aspGetDiscWorkik_podckl: TIntegerField;
    aspGetDiscWorkcname_ckl_disc1: TStringField;
    aspGetDiscWorkik_uch_plan: TIntegerField;
    aspGetDiscWorkuchet: TBooleanField;
    aspGetDiscWorkihour_gos: TIntegerField;
    aspGetDiscWorkik_disc_uch_plan: TIntegerField;
    aspGetDiscWorkik_default_kaf: TIntegerField;
    aspGetDiscWorkiindivid: TIntegerField;
    aspGetDiscWorkViborGroup: TIntegerField;
    aspGetDiscWorkiK_disc1: TIntegerField;
    aspGetDiscWorkcname_disc: TStringField;
    aspGetDiscWorkcshortname: TStringField;
