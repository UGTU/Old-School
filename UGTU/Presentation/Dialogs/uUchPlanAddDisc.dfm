inherited frmUchPlanAddDisc: TfrmUchPlanAddDisc
  Left = 364
  Top = 257
  ...
  object Panel2: TPanel [16]
    ...
    object Panel3: TPanel
      ...
      object ScrollBox1: TScrollBox
        ...
        object dbcbSpclz: TDBLookupComboboxEh
          ...
          OnMouseMove = dbcbSpclzMouseMove
        end
      end
    end
    object Panel4: TPanel
      ...
      object sgDisc: TStringGrid
        ...
        ShowHint = True
        TabOrder = 0
        OnDblClick = sgDiscDblClick
        OnDrawCell = sgDiscDrawCell
        OnExit = sgDiscExit
        OnGetEditMask = sgDiscGetEditMask
        OnGetEditText = sgDiscGetEditText
    ...
    object Button1: TButton
      ...
      Width = 23
      Height = 25
      Hint = #1042#1099#1073#1088#1072#1090#1100' '#1076#1080#1089#1094#1080#1087#1083#1080#1085#1099
  ...
  inherited actBaseDialog: TActionList
    ...
    inherited actSprav: TAction
      OnUpdate = actSpravUpdate
    end
  end
  ...
  object actListCmptnc: TActionList
    Images = imgCmptnc
    Left = 472
    Top = 560
    object actCmptnc: TAction
      Tag = 1
      Caption = 'actCmptnc'
      Hint = #1044#1086#1073#1072#1074#1080#1090#1100' '#1082#1086#1084#1087#1077#1090#1077#1085#1094#1080#1102
      ImageIndex = 1
      OnExecute = actCmptncExecute
    end
    object actAddDiscRelation: TAction
      Caption = 'actAddDiscRelation'
      OnExecute = actAddDiscRelationExecute
    end
  end
