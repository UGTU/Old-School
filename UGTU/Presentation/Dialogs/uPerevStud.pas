...
uses
  ...
  DBCtrlsEh, Mask, DBLookupEh, DBTVStudobj;
...
implementation
uses uDm, uOtchislStud, uDMStudentActions, uDMCauses, uDMUgtuStructure, uDMPrikaz, uMain;
...
or(dbcbeCauseFrom.Text='')
or(dbcbeCauseTo.Text='')
or(dbcbeFac.Text='')
or(dbcbeSpec.Text='')
or(dbcbeGroup.Text='')
then result:=false
