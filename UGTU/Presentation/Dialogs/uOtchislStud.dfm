inherited frmOtchislStud: TfrmOtchislStud
  Left = 336
  Top = 496
  HelpKeyword = 'Stud_exile.htm'
  Caption = #1054#1090#1095#1080#1089#1083#1077#1085#1080#1077' '#1089#1090#1091#1076#1077#1085#1090#1072
  ClientHeight = 228
  ClientWidth = 268
  OldCreateOrder = True
  OnShow = FormShow
  ...
  object dbcbeNumPrik: TDBLookupComboboxEh [8]
    Left = 9
    Top = 24
    Width = 224
    Height = 19
  ...
  object dbcbeCause: TDBLookupComboboxEh [9]
    ...
    ListSource = dmCauses.dsExCause
    TabOrder = 2
    Visible = True
    OnChange = dbcbeNumPrikChange
  end
  object eOtchObosn: TMemo [10]
    Left = 9
    Top = 112
    Width = 253
    Height = 58
