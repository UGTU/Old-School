...
begin
  ...
  try
    ...
    sp_shapka.Parameters.CreateParameter('@ik_ved', ftString, pdInput, 50,
      self.ikVed);
    sp_shapka.Open;
    sp_shapka.First;
    ...
    sp_studs.Parameters.CreateParameter('@ik_ved', ftString, pdInput, 50,
      self.ikVed);
    sp_studs.Open;
    sp_studs.First;
    Result := TVedomost.Create(sp_shapka.FieldByName('Cname_fac_small')
      ...
      sp_shapka.FieldByName('Dd_exam').AsDateTime, 0,
    ...
    begin
      ved := TVedomostItem.Create(sp_studs.FieldByName('ik_zach').AsInteger,
        sp_studs.FieldByName('Cfirstname').AsString,
        sp_studs.FieldByName('Clastname').AsString,
        sp_studs.FieldByName('Cotch').AsString,
        sp_studs.FieldByName('balls_modul').AsInteger);
      sp_studs.Next;
