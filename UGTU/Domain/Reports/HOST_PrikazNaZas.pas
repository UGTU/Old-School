 {*
    Отчет - вывод приказа на заселение в Excel
    Версия:
    Создано: 03.05.2010
    Последняя правка:
    Автор: Лодыгина Л.В.
...
type
   THOST_PrikazNaZas = class(TExcelReportBase)
  private
...
procedure THOST_PrikazNaZas.Execute;
var str: string;
begin
  inherited;
  ...
  NextStep(5,'Создание приказа на заселение');

  Show;
end;

function THOST_PrikazNaZas.GetTotalSteps: Integer;
begin
  result:=10;
end;
