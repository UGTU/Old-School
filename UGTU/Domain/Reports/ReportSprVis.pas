...
type
  SprVisReport = class(TExcelReportBase)
  private
  FikStudGrup:integer;
  protected
  ...
  public
    ...
    constructor Create(_ikStudGrup: integer);
...
constructor SprVisReport.Create(_ikStudGrup: integer);
begin
  FikStudGrup := ikStudGrup;
end;
{ SpravkaReport }

procedure SprVisReport.Execute;
var
