...
type
  ...
  public
    ...
    // source - источник данных в Ѕƒ (можно с инструкцией where)
    destructor Destroy; virtual;
  ...
  // команды (процедуры) работы с ведомост€ми
  TUpdateVedCommand = class(TBaseADOCommand)      //редактирует или удал€ет ведомость
  public
  ...
  TAddVedUspevCommand = class(TBaseADOCommand) //добавл€ет ведомость вместе с успеваемостью
  public
  ...
  { управление ведомост€ми: загрузка, создание всех ведомостей группы
    сохранение свойств }
  ...
  public
    ...
    property UspevDataSet: TADODataSet read GetUspevDataSet;      //DataSet с успеваемостью дл€ текущей ведомости
  end;
  ...
  {управление направлени€ми студента}
  ...
  private
    ...
    FContentNapr: TContentNapravController;   //набор предметов дл€ создани€ направлений
    procedure setContent(const Value: integer);
  ...
  try
    ...
    begin
      ...
      raise EApplicationException.Create
        ('ѕроизошла ошибка при сохранении успеваемости.', E);
      exit;
    end;
  end;
...
begin
  ...
  try
    ...
    FAppendUspevCommand.DoIt(FStudGrupIK, cosenca);                                         //сохран€ем оценку
    if KPTema<>'' then FAppendUspevKPThemeCommand.DoIt(FStudGrupIK,KPTema);                 //сохран€ем тему
    ...
    begin
      ...
      Result := FailError;
      raise EApplicationException.Create
        ('ѕроизошла ошибка при закрыти направлени€.', E);
      exit;
    end;
  end;
