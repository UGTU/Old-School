...
//***************Дополнительные**************************
  ...
  //экспорт справок
  function BuildSpravka2014(_ikStudGrup, _type_spr,num: integer):TReportBase;
...
//если есть виды занятий
 ...
 function TUspevGroupController.BuildSpravka2014(_ikStudGrup, _type_spr,num: integer):TReportBase;
