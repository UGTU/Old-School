...
{$ENDIF}
  Graphics, Controls, Forms, DesignMenus,
...
{$ENDIF}
//  ColectEditorEh,
  ToolWin, ToolCtrlsEh, GridsEh, DBAxisGridsEh, MemTableEh, DataDriverEh,
  Classes, TypInfo;
    ...
    1:
      begin
        ...
        begin
          ...
          GetComponentNames(lst, TDataSource, False);
...
//          else
    ...
    begin
      ...
      begin
        ...
        AssignCompPropMenuItem.PropValueClass := TDataSource;
