--select * from [SprAkadem] where Ik_studGrup=20436
	Alter view [dbo].[SprAkadem]
	AS							
		select sg.Ik_studGrup, _content.ik_upContent, cName_disc, _vid_zan.[cName_vid_zanyat],_content.n_sem , CAST (0 as bit) flag
		from 
