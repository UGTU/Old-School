select Cshort_name_fac, Cname_spec,CType_kat,Cname_form_ed,FIO,pr.Cregion from
(
...
where 
--((pr.Ik_region !=1)or(fac.Ik_region !=1)or(vrem.Ik_region !=1))
--and (Ik_grazd = 2) 
(pr.Ik_region IN (6184,45))or(fac.Ik_region IN (6184,45))or(vrem.Ik_region IN (6184,45))
