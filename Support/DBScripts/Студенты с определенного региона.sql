...
(Select distinct Person.nCode,Fac.Cname_fac,Spec_stud.Cname_spec,Form_ed.Cname_form_ed, cast((year(GETDATE())-Grup.nYear_post+1) as varchar(2)) + ' ' + 'курс' as Course,
				 Cshort_name_fac,Grup.Cname_grup,Clastname +' '+substring(Cfirstname,1,1) +'. '+ isnull(substring(Cotch,1,1),'')+'.' fio, cast(Person.Dd_birth AS DATE) Dd_birth, Person.ctelefon,Person.cSotTel
