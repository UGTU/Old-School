select distinct Clastname +' '+ Cfirstname +' '+ isnull(Cotch,'') FIO, cast(Dd_birth as date), ctelefon, cSotTel, [Cplacebirth], Cname_grup, Cname_spec, Cshort_name_fac,
...
and DATEADD(YEAR,25,Dd_birth)<=cast('2014-11-19' as datetime) --DATEDIFF(yy, Dd_birth, GETDATE())>17 
and DATEADD(YEAR,38,Dd_birth)>=cast('2014-11-19' as datetime)
--and (Ik_form_ed = 1)
and Fac.ik_fac not in (15,17)
and Person.lSex = 1
--and grazd.ik_grazd = 2 --российское гражданство
) Allstud
